...
프로그래머스의 문제 언어 선택에서는 `and`의 조건으로 검색이 됩니다. 

![OR의 예](https://user-images.githubusercontent.com/84373490/152965257-3d937470-0fa6-422f-9fa0-b27cfa7a99b2.jpg)

쇼핑몰에서 브랜드 선택에서는 `or`의 조건으로 검색이 됩니다.
